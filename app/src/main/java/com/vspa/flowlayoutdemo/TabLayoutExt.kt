...
data class TextScaleConfig(
    val onSelectTextSize: Int = 10,
    val onUnSelectTextSize: Int = 10,
    val onSelectTextColor: Int = Color.BLACK,
    val onUnSelectTextColor: Int = Color.BLACK,
    val switchBold:Boolean = false
)

private val defaultScaleConfig = TextScaleConfig(onSelectTextSize = 14.dp,
    onUnSelectTextSize = 12.dp,
    onSelectTextColor = Color.BLACK,
    onUnSelectTextColor = Color.BLACK)
...
private fun TabLayout.addScaleAnim(config: TextScaleConfig = defaultScaleConfig) {
    ...
    val listener = object : TabLayout.OnTabSelectedListener {
        private fun scaleTextSize(stv: ScaleTexViewTabView, size: Int, isBold: Boolean, onSelect: Boolean) {
            cancelLastAnim(stv)
            val animator =
            ...
            animator.addUpdateListener { anim ->
                ...
                textSize?.let { ts ->
                    stv.textSizePx = size
                    if(onSelect) stv.setTextColor(Color.parseColor("#333333"))
                    else stv.setTextColor(Color.parseColor("#999999"))
                }
            }
            animator.doOnStart {
...
fun TabLayout.createMediatorByTextView(
    vp: ViewPager2,
